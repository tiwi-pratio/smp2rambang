...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Halo! Saya asisten SIAKAD SMP Negeri 2 Rambang. Ada yang bisa saya bantu?",
    },
  ]);
  ...
  return (
    <>
      {/* Chat Panel */}
      {open && (
        <div className="fixed bottom-20 right-5 z-50 w-80 sm:w-96 flex flex-col shadow-2xl rounded-2xl overflow-hidden border border-border bg-white"
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-[hsl(210,40%,98%)]"
